...
suite's xdist and coverage checks skip themselves when those two plugins are absent, and
a skipped check is one the run did not prove, so a complete local run needs both.
